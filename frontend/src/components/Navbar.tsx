            ...
            <>
              ...
              {onOpenImport && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-500/20 hover:bg-amber-500/30 border border-amber-500/40 text-amber-300 hover:text-amber-200 text-xs font-semibold transition-all shadow-sm cursor-pointer"
                  title="Upload screenplay breakdown CSV or JSON specification"
                >
